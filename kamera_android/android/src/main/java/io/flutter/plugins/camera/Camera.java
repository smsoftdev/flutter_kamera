...
class Camera
  ...
  private void prepareMediaRecorder(String outputFilePath) throws IOException {
    ...
    CamcorderProfileX cpx = getRecordingProfileLegacyX();
    if (cpx != null) {
      mediaRecorderBuilder = new MediaRecorderBuilder(cpx, outputFilePath);
  ...
  CamcorderProfileX getRecordingProfileLegacyX() {
    return cameraFeatures.getResolution().getRecordingProfileLegacyX();
  }
